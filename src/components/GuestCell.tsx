...
const GuestCellSelect = ({ label, formName, onChange, value }: {label: string, formName:string, onChange:any, value: number}) => {
  return (
        <IonGrid>
            ...
            <IonRow className="ion-justify-content-end">
                <IonCol>
                    <IonSelect name={formName} placeholder="0" onIonChange={onChange} value={value}>
...
const GuestCellTextarea = ({ label, formName, onChange, value }: {label: string, formName: string, onChange:any, value:string}) => {
    return (
            <IonGrid>
                ...
                <IonRow>
                    <IonCol>
                        <IonTextarea fill="outline" name={formName} placeholder="Any notes?" onIonChange={onChange} value={value}></IonTextarea>
                    </IonCol>
                </IonRow> 
            </IonGrid>
    );
